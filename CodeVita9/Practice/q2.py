...
first_list=list(filter(findPrime,[x for x in range(first,last)]))
combination_list=combination(first_list)
second_list=list(filter(findPrime,combination_list))
print(fibonacci(min(second_list),max(second_list),len(second_list)))
